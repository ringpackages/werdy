...
MainWin = New qApp {
        ...
        win1 = new qwidget() {
			resize(400,500)
			setwindowtitle("وردي - الإصدار التجريبي 1.0")
...
/* help */
			page5= new qwidget() {
				...
				{
					loadpage(new qurl("file:///"+werdyDir()+"/web/help/index.html"))
				}
			...
			sitelink= new qlabel(win1){
				setopenexternallinks(true)
				settext("<a href='http://werdy.info/'>موقع وردي</a>")
			}
